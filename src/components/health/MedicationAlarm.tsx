...
export function MedicationAlarm({ time, active, onToggle, className }: MedicationAlarmProps) {
  ...
  return (
    <div className={cn("flex items-center gap-1 text-2xs bg-gray-50 dark:bg-gray-800 p-1 rounded-lg", className)}>
